...
default_args = {
    ...
    'retry_delay': timedelta(seconds=10),  # Reduced from 5 minutes
}
...
with DAG(
    ...
    bash_log_task = BashOperator(
        ...
        bash_command='echo "Bash task output"; echo "Processing complete"',
    )

    # This task will fail - useful for testing error logs
    # Commented out for faster testing, uncomment to test error logs
